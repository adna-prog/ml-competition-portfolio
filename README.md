...
| Predicting Student Test Scores (Kaggle S6E1) | Régression tabulaire | **8.73988 private RMSE** | LightGBM + Optuna borné + features attendance/study/sleep ; données brutes et probing exclus |
